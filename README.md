...
- [📖 React+Rails One Repo App ](#-React+Rails One Repo-app-)
...
- **Rails 7.1.1 (lastest)+ Postgres with rails-jsbundler that is connected to Webpacker**
...
```sh
  cd your-folder
  git@github.com:cancelei/hello-rails-react2.git
```
